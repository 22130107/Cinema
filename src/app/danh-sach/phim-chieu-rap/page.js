  ...
  useEffect(() => {
    const fetchMovies = async () => {
      try {
        ...
        // Fetch phim-chieu-rap
        for (let page = 1; page <= 10; page++) {
          try {
            const res = await fetch(`https://ophim1.com/v1/api/danh-sach/phim-chieu-rap?page=${page}`);
            ...
            if (page === 1) console.error('Failed to fetch phim-chieu-rap:', err);
            break;
          }
        }
