  ...
  useEffect(() => {
    const fetchMovies = async () => {
      try {
        ...
        try {
          const res1 = await fetch(`https://ophim1.com/v1/api/danh-sach/phim-bo-dang-chieu?page=1`);
          ...
          console.error('Failed to fetch phim-bo-dang-chieu page 1:', err);
        }
        ...
        for (let page = 2; page <= 10; page++) {
          promises.push(
            fetch(`https://ophim1.com/v1/api/danh-sach/phim-bo-dang-chieu?page=${page}`)
              .then(res => res.json())
